...
func buildGoldmarkWithInlineTag(conf Config) goldmark.Markdown {
	return goldmark.New(goldmark.WithExtensions(New(conf)))
}

var (
	markdown                = goldmark.New()
	markdownWithSuperscript = buildGoldmarkWithInlineTag(Config{Superscript: SuperscriptConfig{Enable: true}})
	markdownWithSubscript   = buildGoldmarkWithInlineTag(Config{Subscript: SubscriptConfig{Enable: true}})
	markdownWithInsert      = buildGoldmarkWithInlineTag(Config{Insert: InsertConfig{Enable: true}})
	markdownWithMark        = buildGoldmarkWithInlineTag(Config{Mark: MarkConfig{Enable: true}})
)
...
func TestSubscript(t *testing.T) {
	markdown := goldmark.New(
		goldmark.WithExtensions(New(Config{Subscript: SubscriptConfig{Enable: true}}), extension.Strikethrough))
